...
function salvar() {
    ...
    if (codigo && nome && fabricante && datalançamento) {// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                 chocolate = new Chocolate(codigo, nome,fabricante,datalançamento);
                listaChocolate.push(chocolate);
                mostrarAviso("Inserido na lista");
                break;
            case 'alterando':
               let chocolateAlterado = new Chocolate(codigo, nome,fabricante, datalançamento);
...
function mostrarDadoschocolate(chocolate) {
    ...
    document.getElementById("inputDatalançamento").value = chocolate.datalançamento;
