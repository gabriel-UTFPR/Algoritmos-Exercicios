...
function salvar() {
    ...
    const preçoEtiqueta = parseFloat(document.getElementById("inputPreçoEtiqueta").value).toFixed(2);
    const valorbooleano = document.getElementById("inputehAlcolico").value;
    if (valorbooleano) {
        ehAlcolico="Não";
    }else{
        ehAlcolico="Sim";
    ...
    if (id && nome && fabricante && preçoEtiqueta>0) {// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                 bebida = new Bebida(id, nome,fabricante,preçoEtiqueta,ehAlcolico);
                listaBebida.push(bebida);
                mostrarAviso("Inserido na lista");
                break;
            case 'alterando':
               let BebidaAlterado = new Bebida(id, nome,fabricante, preçoEtiqueta,ehAlcolico);
...
function mostrarDadosBebida(bebida) {
    ...
    document.getElementById("inputPreçoEtiqueta").value = bebida.preçoEtiqueta;
    document.getElementById("inputehAlcolico").value = bebida.ehAlcolico;
...
function limparAtributos() {
    ...
    document.getElementById("inputPreçoEtiqueta").value="";
    document.getElementById("inputehAlcolico").value = "";
...
function bloquearAtributos(soLeitura) {
    ...
    document.getElementById("inputPreçoEtiqueta").readOnly=soLeitura;
